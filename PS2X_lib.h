/******************************************************************
*  Super amazing PS2 controller Arduino Library v1.4
...
PS2X(SPIClass &spi, int freq, bool enACK = false) : SPIn(spi), SPIspeed(freq), waitforACK(enACK) {}
